...
public class TfsSession {
    ...
    public byte[] readData(int blockId, long fileId, int offset, int length, long primaryDs)
        throws TfsException {
    ...
    public RespReadDataMessageV2 readDataV2(int blockId, long fileId,
                                            int offset, int length, long primaryDs)
        throws TfsException {
    ...
    public int unlinkFile(int blockId, long fileId, int action, int optionFlag,
