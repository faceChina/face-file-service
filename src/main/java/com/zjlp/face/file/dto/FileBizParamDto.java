 ...
 */
public class FileBizParamDto implements Serializable {
	...
	public FileBizParamDto(String zoomSizes, Long userId, String shopNo,
			String tableName, String tableId, String code, Integer fileLabel) {
		super();
		this.zoomSizes = zoomSizes;
		this.userId = userId;
		this.shopNo = shopNo;
